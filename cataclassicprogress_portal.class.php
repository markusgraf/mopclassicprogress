		...
		$settings	= array(
			...
			'boss1'	=> array(
				...
				'options'	=> array(
					...
					'classic_0_5'	=> $this->user->lang('classic_0_5'),
					'classic_1_5'	=> $this->user->lang('classic_1_5'),
					'classic_2_5'	=> $this->user->lang('classic_2_5'),
					'classic_3_5'	=> $this->user->lang('classic_3_5'),
					'classic_4_5'	=> $this->user->lang('classic_4_5'),
			...
			'boss2'	=> array(
				...
				'options'	=> array(
					'classic_phase1'	=> $this->user->lang('classic_phase1'),
					'classic_0_2'	=> $this->user->lang('classic_0_2'),
					'classic_1_2'	=> $this->user->lang('classic_1_2'),
					'classic_clear'	=> $this->user->lang('classic_clear'),
				),
			),				
				#Blackwing Descent
			...
			'boss4'	=> array(
				...
				'options'	=> array(
					'classic_phase1'	=> $this->user->lang('classic_phase1'),					
					'classic_0_3'	=> $this->user->lang('classic_0_3'),
					'classic_1_3'	=> $this->user->lang('classic_1_3'),
					'classic_2_3'	=> $this->user->lang('classic_2_3'),
					'classic_clear'	=> $this->user->lang('classic_clear'),
				),
			),
			...
			'boss5'	=> array(
				...
				'options'	=> array(
					...
					'classic_0_7'	=> $this->user->lang('classic_0_7'),
					'classic_1_7'	=> $this->user->lang('classic_1_7'),
					'classic_2_7'	=> $this->user->lang('classic_2_7'),
					'classic_3_7'	=> $this->user->lang('classic_3_7'),
					'classic_4_7'	=> $this->user->lang('classic_4_7'),
					'classic_5_7'	=> $this->user->lang('classic_5_7'),
					'classic_6_7'	=> $this->user->lang('classic_6_7'),
					'classic_clear'	=> $this->user->lang('classic_clear'),
